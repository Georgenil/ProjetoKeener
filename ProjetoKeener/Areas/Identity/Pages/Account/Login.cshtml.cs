...
using ProjetoKeener.Areas.Identity.Data;

namespace ProjetoKeener.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<WebApplication2User> signInManager, 
